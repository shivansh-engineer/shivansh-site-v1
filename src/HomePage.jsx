...
export default function HomePage() {
  return (
    <main className="grid grid-cols-1 lg:grid-cols-4 gap-8 px-4 sm:px-6 lg:px-12 xl:px-20 2xl:px-40 py-12">
      {/* Sidebar */}
      <aside className="lg:col-span-1 space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Shivansh Chaudhary</h1>
        ...
        <div>
          <h2 className="text-lg font-semibold mb-2 text-gray-800">About Me</h2>
        ...
        <div className="flex flex-col gap-3">
          ...
          <a
            ...
            className="inline-flex items-center border border-black px-4 py-2 rounded hover:bg-gray-100"
          >
      ...
      <section className="lg:col-span-3 space-y-12">
        ...
        <GridSection title="Publications & IP">
          <Card
            title="Architecting a Multi-GHz Real-Time RF Streaming System"
            description="Published in IEEE Xplore"
            link="https://ieeexplore.ieee.org/document/8230956"
          />
          <Card
            title="Addressing the Challenges of Testing Multi-Channel Phase-Coherent Systems"
            description="Published in Microwave Journal"
          />
          <Card
            title="Design of a Modularized Radar Test System"
            description="Published in Microwave Journal"
            link="https://www.microwavejournal.com/articles/28303-design-of-a-state-of-the-art-modularized-radar-test-system"
          />
          <Card
            title="Characterization for Multi-Channel Phase-Coherent Systems"
            description="Published in IEEE Instrumentation & Measurement Journal"
            link="https://www.researchgate.net/publication/305923015_Characterization_and_calibration_techniques_for_multi-channel_phase-coherent_systems"
          />
          <Card
            title="Check the Specifications When Selecting a Signal Generator"
            description="Published in Microwaves & RF"
            link="https://www.mwrf.com/technologies/test-measurement-generators/article/21846791/check-the-specs-when-selecting-a-signal-generator?"
          />
          <Card
            title="More Hz for More Bits: Solving the Wireless Throughput Challenge with More Bandwidth"
            description="Published in High Frequency Electronics"
            link="http://highfrequencyelectronics.com/index.php?option=com_content&view=article&id=1484:more-hz-for-more-bits-solving-the-wireless-throughput-challenge-with-more-bandwidth&catid=140:2016-07-july-articles&Itemid=189"
          />
        </GridSection>

        <section className="space-y-4">
  <h2 className="text-2xl font-semibold border-b pb-2 text-gray-800">Education</h2>
