    ...
    <main className="grid grid-cols-1 lg:grid-cols-4 gap-8 px-4 sm:px-6 lg:px-12 xl:px-20 2xl:px-40 py-10">
      ...
      <section className="lg:col-span-3 space-y-10">
        <GridSection title="Professional Experience">
          <Card title="Senior Director of Product, Salesforce AI [2024–Present]" description="Leading the vision and execution of Agentforce — Trusted AI Agents" link="https://www.salesforce.com/form/agentforce/demo/?d=7013y0000020HCRAA2" />
